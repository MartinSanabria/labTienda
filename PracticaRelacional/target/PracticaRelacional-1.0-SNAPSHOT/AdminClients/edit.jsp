...
<div class="container mt-3">
        <form method="post" action="ClientsController?action=update&id=${clientEdit.getIdcliente()}">
            <div class="mb-3 row">
                <label for="nombre" class="col-3 col-form-label">Ingrese el nombre</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="nombre" id="nombre" value="${clientEdit.getNombres()}" required>
                </div>
            </div> 
            <div class="mb-3 row">
                <label for="apellido" class="col-3 col-form-label">Ingrese el apellido</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="apellido" id="apellido" value="${clientEdit.getApellidos()}"  required>
                </div>
            </div> 
            <div class="mb-3 row">
                <label for="sexo" class="col-3 col-form-label">Ingrese su sexo</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="sexo" id="sexo" value="${clientEdit.getSexo()}"  required>
                </div>
            </div> 
            <div class="mb-3 row">
                <label for="telefono" class="col-3 col-form-label">Ingrese el telefono</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="telefono" id="telefono" value="${clientEdit.getTelefono()}"  required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="direccion" class="col-3 col-form-label">Ingrese su dirección</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="direccion" id="direccion" value="${clientEdit.getDireccion()}" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="pais" class="col-3 col-form-label">Ingrese el pais</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="pais" id="pais" value="${clientEdit.getPais()}" required>
                </div>
            </div> 
            <div class="mb-3 row">
                <label for="email" class="col-3 col-form-label">Ingrese su correo</label>
                <div class="col-8">
                    <input type="email" class="form-control" name="email" id="email" value="${clientEdit.getCorreo()}"  required>
                </div>
            </div> 
            <div class="mb-3 row">
                <label for="password" class="col-3 col-form-label">Ingrese su contraseña</label>
                <div class="col-8">
                    <input type="password" class="form-control" name="password" id="password" value="${clientEdit.getClave()}" required>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="password" class="form-control" name="confirm-password" id="confirm-password" value="${clientEdit.getClave()}" required>
