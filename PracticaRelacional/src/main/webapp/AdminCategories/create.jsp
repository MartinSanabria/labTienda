...
<div class="container mt-3">
        <form method="post" action="/PracticaRelacional/CategoriesController?action=create">
            <div class="mb-3 row">
                <label for="inputName" class="col-4 col-form-label">Ingrese el nombre de la categoria</label>
                <div class="col-8">
