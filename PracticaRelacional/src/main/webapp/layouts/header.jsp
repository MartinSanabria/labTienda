        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/PracticaRelacional/AdminPedidosController">Pedidos</a>
              </li>
            </ul>
          </div>
          
         <a href="/PracticaRelacional/LogoutController" class="btn btn-secondary">Cerrar Sesión</a>
