            ...
            <div class="col-md-4">
                ...
                <div class="card mt-3" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <hr/>
                        <c:set var="totalPago" value="${total + iva}" />
                        <p id="totalPagar">Total a pagar $ <fmt:formatNumber value="${totalPago}" type="number" pattern="#,##0.00" /></p>
                        <c:if test="${empty cliente}">
                            <a href="CarritoController?action=login" class="btn btn-success"">Iniciar sesión</a>
                        </c:if>
                        <c:if test="${not empty cliente}">
                            <a href="PedidoController?action=pedido" class="btn btn-success">Generar pedido</a>
                        </c:if>
                    </div>
                </div>
            </div>
